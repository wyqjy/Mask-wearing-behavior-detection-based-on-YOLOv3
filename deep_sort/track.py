...
class Track:
    ...
    def __init__(self, mean, covariance, track_id, n_init, max_age,
                 feature=None):
        self.mean = mean  #框的位置信息
        self.covariance = covariance  #运动状态信息  速度
        self.track_id = track_id
        self.hits = 1  #代表了匹配了多少次  计数由不确定到确定 和n_init比较
        self.age = 1   #没有用到，和time_since_update功能重复
        self.time_since_update = 0  #每次调用predict函数的时候就会+1
        ...
        self._n_init = n_init   #由不确定到确定
        self._max_age = max_age  #最大存活期
